...
namespace nebula {
    ConjunctionExpression::ConjunctionExpression(ExpressionType type): ParsedExpression(
        type, ExpressionClass::CONJUNCTION) {
    }
    ...
    ConjunctionExpression::ConjunctionExpression(ExpressionType type, std::unique_ptr<ParsedExpression> left,
